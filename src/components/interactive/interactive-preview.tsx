 ...
 * customer taps them on their own device). Its own dedicated `Interactive`
 * namespace keeps it decoupled from the composer/automation-builder/
 * quick-replies-manager namespaces it's dropped into.
 */
    ...
    >
      <div className="px-3 py-2">
        ...
        <p className="whitespace-pre-wrap break-words text-sm">
          {payload.body || (
            <span className="text-muted-foreground">{t("bodyFallback")}</span>
          )}
        </p>
        {payload.footer ? (
